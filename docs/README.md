...
Bu klasör projenin geliştirme rehberlerini içerir.

- [development-guidelines.md](development-guidelines.md) — Kod stili, test, hata yönetimi, CI önerileri.
- [wails-v2-reference.md](wails-v2-reference.md) — Wails v2 hızlı referans (kurulum, opsiyonlar, build).
